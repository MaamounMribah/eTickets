...
namespace eTickets.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var moviesList = await MovieService.GetAllAsync(n => n.Cinema);
        ...
        {
            var movieDetail = await MovieService.GetMovieByIdAsync(id);
        ...
        {
            var movieDropdownsData = await MovieService.GetNewMovieDropdownsValues();
